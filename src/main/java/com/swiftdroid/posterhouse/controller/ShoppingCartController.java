...
public String addItem(
		...
		@RequestParam("file") MultipartFile imageMultipart) {
...
e.printStackTrace();
	...
	CartItem cartItem = cartItemService.addProductToCartItem(path,productConfig,product, user, Integer.parseInt(qty));
...
if(qty==0) {
	...
	System.out.println("id  null In ShoppingCartController   Method:: updateShoppingCart  ::  "+e.getMessage());
   	 return "badRequestPage";
		}
